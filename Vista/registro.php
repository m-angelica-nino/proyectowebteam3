...
<body>
<?php
    include_once 'plantillanavbarregistro.php'
    ?>
    <div class="container">
            ...
            <div class="card2">
                ...
                <div class="card-body">
                    <form>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group form-group">
                                    ...
                                    <input autocomplete="off" type="text" class="form-control" placeholder="Nombres">
                                ...
                                <div class="input-group form-group">
                                    ...
                                    <input autocomplete="off" type="number" class="form-control" placeholder="Telefono">
                        ...
                        <button type="submit" class="btn btn-secundary flotar-der">Cancelar</button>
