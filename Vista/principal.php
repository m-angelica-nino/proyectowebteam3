      ...
      <div class="collapse" id="collapseExample">
        <div class="card card-body">
          ...
          <form>
            ...
            <button type="submit" class="btn btn-warning alin">
              Filtrar
            </button>
          </form>
        </div>
    ...
    <div class="store-wrapper">
      <section class="products-list">
        ...
        <div class="card" style="width: 100%">
          <div class="row no-gutters">
            <div class="col-sm-3">
              <img class="card-img tam img-thumbnail" src="../src/images/tryp.jpg" alt="Suresh Dasari Card" />
            </div>
            <div class="col-sm-5">
              <div class="card-body">
        ...
        <div class="card" style="width: 100%">
          <div class="row no-gutters">
            <div class="col-sm-3">
              <img class="card-img tam img-thumbnail" src="../src/images/hampton.jpg" alt="Suresh Dasari Card" />
            </div>
            <div class="col-sm-5">
              <div class="card-body">
